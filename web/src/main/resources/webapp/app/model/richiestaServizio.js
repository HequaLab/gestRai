            ...
            convert: function(v, rec) {
                ...
                */
                ...
                if (dataFineServizio <= fineData){
                    ...
                    mesiComputo = monthDiff(dataInizioServizio ,dataFineServizio);
                    console.log("Mesi computo:" + mesiComputo);
                    console.log("Inizio data: " + dataInizioServizio + " dataFine: " +  fineData);
                }
                else {
                    // caso 2
                    ...
                    // Mesi computo da applicare al periodo analizzato
                    mesiComputo = monthDiff(dataInizioServizio, fineData);
                    console.log("Mesi computo:" + mesiComputo);
                    console.log("Inizio data: " + dataInizioServizio + " dataFine: " +  fineData);
                }
