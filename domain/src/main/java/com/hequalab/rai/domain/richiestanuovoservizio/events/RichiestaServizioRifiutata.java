...
public class RichiestaServizioRifiutata
	extends DefaultEvent<RichiestaNuovoServizioId> {
    
    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unused")
    private RichiestaServizioRifiutata() {
    }
    
    UserId user;
    LocalDateTime timeStamp;

    public RichiestaServizioRifiutata(RichiestaNuovoServizioId id, UserId user, LocalDateTime timeStamp) {
	super(id);
	this.setUser(user);
