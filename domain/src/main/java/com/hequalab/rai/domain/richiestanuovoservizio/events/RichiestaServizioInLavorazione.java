...
public class RichiestaServizioInLavorazione
	extends DefaultEvent<RichiestaNuovoServizioId> {
    
    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unused")
    private RichiestaServizioInLavorazione() {
    }
    
    UserId user;
    LocalDateTime timeStamp;

    public RichiestaServizioInLavorazione(RichiestaNuovoServizioId id, UserId user, LocalDateTime timeStamp) {
	super(id);
	this.setUser(user);
